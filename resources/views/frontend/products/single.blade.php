...
@section('content')
 ...
 <div class="container">
    <div class="bread-crumb flex-w p-t-30">
        <a href="{{route('home.products.index')}}" class="mtext-106 cl8 hov-cl1 trans-04">
            خانه
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                <ul class="p-lr-28 p-lr-15-sm">
                                    <li class="flex-w flex-t p-b-7">
                                        <span class="mtext-106 cl3 size-205 text-danger">
                                            صاحب طرح
                                        </span>
                ...
                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="/{{$similar->demo_url}}" alt="IMG-PRODUCT">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                <a href="{{ route('home.products.single',$similar->id) }}" class="mtext-106 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                    {{$similar->title}}
                                </a>

                                <span class="stext-105 cl3">
                                {{$similar->price}} هزار تومان
                            </span>
                            </div>
                        </div>
                    </div>
