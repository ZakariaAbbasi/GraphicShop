    ...
    <header class="header-v4">
        ...
        <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
            <div class="container-search-header">
                ...
                <form class="wrap-search-header flex-w p-l-15" action="{{ route('home.products.search') }}"
                    method="get">
            ...
            <div class="header-cart-content flex-w js-pscroll">
                    ...
                    @if (!Cookie::get('basket') == null)
                        @foreach (json_decode(Cookie::get('basket'), true) as $id => $value)
                            ...
                            <li class="header-cart-item flex-w flex-t m-b-12">
                                <a href="{{ route('home.basket.remove', ['id'=> $id]) }}">
                                ...
                                <div class="header-cart-item-txt p-t-8">
                                    <a href="{{ route('home.products.single', $id) }}"
                ...
                <div class="w-full">
                    ...
                    <div class="header-cart-buttons flex-w w-full">
                        ...
                        <a href="{{ route('home.checkout')}}" onclick=" return {{json_decode(Cookie::get('basket'), true) == null? 'false' : '' }}" class="flex-c-m stext-101 cl0 size-107 w-100 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-l-8 m-b-10">
